...
const postHtmlStyles = `
  ...
  .post-content h1 { font-size: 2rem; font-weight: 700; margin: 2rem 0 1rem; line-height: 1.3; scroll-margin-top: 84px; }
  .post-content h2 { font-size: 1.5rem; font-weight: 600; margin: 1.75rem 0 0.75rem; line-height: 1.35; scroll-margin-top: 84px; }
  .post-content h3 { font-size: 1.25rem; font-weight: 600; margin: 1.5rem 0 0.5rem; line-height: 1.4; scroll-margin-top: 84px; }
