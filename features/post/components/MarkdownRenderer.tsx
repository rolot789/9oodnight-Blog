...
const htmlStyles = `
  ...
  .blocknote-html-content h2 { font-size: 1.5rem; font-weight: 600; margin: 12px 0 8px !important; }
  .blocknote-html-content h3 { font-size: 1.25rem; font-weight: 600; margin: 8px 0 8px !important; }
